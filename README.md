...
IF (Instruction Fetch) – loads instructions from memory
ID (Instruction Decode & Register Fetch) – decodes opcodes and reads register values
EX (Execute) – performs arithmetic and logic operations using the ALU
MEM (Memory Access) – reads/writes data to memory
